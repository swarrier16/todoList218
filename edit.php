...
<body>
  ...
  <div id="login-page" class="row">
    <div class="col s12 z-depth-4 card-panel">
      <form class="login-form" method="POST" action="edittask.php">
       ...
       <?php } ?> 
        <div class="row">
          <div class="input-field col s12 center">
            <p class="center login-form-text">Edit Task</p>
          </div>
        </div>
        ...
        <div class="row margin">
          <div class="input-field col s12">          
            <input placeholder="Start Date (yyyy-mm-dd hh:mm:ss)" id="due" name ="due" value="">
        ...
        <div class="row">
          <div class="input-field col s12">
            <input class="btn waves-effect waves-light col s12" type="submit" name ="edit" value="Submit">
          </div>
        </div>
